...
Foam::tmp<Foam::surfaceScalarField> Foam::multiphaseSystem::cAlphaGamma
(
    const volScalarField& alpha1,
    const volScalarField& alpha2
) const
...
Foam::tmp<Foam::surfaceScalarField> Foam::multiphaseSystem::cAlphaSwitch
(
    surfaceScalarField& gamma
) const
{

    const double gammaStar = 0.4;  
    
    forAll(gamma.internalField(),I)
    {
        if (gamma.internalField()[I] < gammaStar)
        {
            gamma.primitiveFieldRef()[I] = 0.0;
        }
        else
        {
            gamma.primitiveFieldRef()[I] = 1.0;
        }
    }
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseSystem::cAlphaGammav
(
    const volScalarField& alpha1,
    const volScalarField& alpha2
) const
...
Foam::tmp<Foam::volScalarField> Foam::multiphaseSystem::cAlphaSwitchv
(
...
{    
    ...
    forAll(gammav.internalField(),I)
    {
        if (gammav.internalField()[I] < gammaStar)
        {
            gammav.primitiveFieldRef()[I] = 0.0;
        }
        else
        {
            gammav.primitiveFieldRef()[I] = 1.0;
        }
    }
...
void Foam::multiphaseSystem::calcCAlpha()
{
    cAlpha_ == 0.0;
